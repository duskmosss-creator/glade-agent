...
**Syntax:** `^new`  
**Example:** `^new`  
**Description:** Starts a fresh chat session. The AI will "forget" the previous conversation history and start with a clean slate.  
**Output:** "✓ New chat session started (ID: 123456). Memory wiped."

### **Debug Context**

**Syntax:** `^context`  
**Example:** `^context`  
**Description:** (Debug) Shows what the AI currently "sees" in its memory, including recent messages and active session ID.  
**Output:** A list of the last 3 messages in the active session.

---

## 2. Research & Analysis (V2)

### **Deep Research**

**Syntax:** `!research <topic>`  
**Example:** `!research History of Roman Aqueducts`  
**Description:** Initiates a deep research session using the autonomous Research Agent (Reasoning + Acting). The agent plans, searches the web, and compiles a PDF report.  
**Output:** A status update ("Starting research...") followed by a link to the generated PDF report.
...
**Syntax:** `!radar <location> <miles> gif 30`  
**Example:** `!radar Seattle 30 gif 30`  
